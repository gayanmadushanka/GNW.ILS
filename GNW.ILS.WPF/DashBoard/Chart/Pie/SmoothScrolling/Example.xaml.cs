...
namespace Telerik.Windows.Examples.ChartView.SmoothScrolling
{
    public partial class Example : UserControl
    {
        public Example()
        {
            ...
            {
                this.Resources.MergedDictionaries.Add(new System.Windows.ResourceDictionary() { Source = new Uri("/Pervation.Presentation;component/DashBoard/Chart/SmoothScrolling/Win8TouchResources.xaml", UriKind.RelativeOrAbsolute) });
            }
            else
            {
                this.Resources.MergedDictionaries.Add(new System.Windows.ResourceDictionary() { Source = new Uri("/Pervation.Presentation;component/DashBoard/Chart/SmoothScrolling/Win8Resources.xaml", UriKind.RelativeOrAbsolute) });
            }
            InitializeComponent();
        }
