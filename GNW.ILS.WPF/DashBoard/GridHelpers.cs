...
namespace Pervation.Presentation.DashBoard
{
    public class GridHelpers
    {
        ...
        public static void ColumnCountChanged(DependencyObject obj, DependencyPropertyChangedEventArgs e)
        {
            ...
            for (int i = 0; i < (int)e.NewValue; i++) grid.ColumnDefinitions.Add(new ColumnDefinition() { Width = GridLength.Auto });
        ...
        private static void SetStarColumns(Grid grid)
        {
            ...
            {
                if (starColumns.Contains(i.ToString(CultureInfo.InvariantCulture))) grid.ColumnDefinitions[i].Width = new GridLength(1, GridUnitType.Star);
            }
        }
        ...
        private static void SetStarRows(Grid grid)
        {
            ...
            {
                if (starRows.Contains(i.ToString(CultureInfo.InvariantCulture))) grid.RowDefinitions[i].Height = new GridLength(1, GridUnitType.Star);
            }
        }
    }
