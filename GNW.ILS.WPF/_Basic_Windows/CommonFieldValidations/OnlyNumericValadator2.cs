...
{
    class OnlyNumericValadator2
    {
        public void IsTextAllowed(object sender)
        {
            try
            {
        ...
        public void AllowOnlyDecimals(object sender)
        {
            try
            {
                TextBox textBox = sender as TextBox;
        ...
        public void AllowOnly_0_Decimals(object sender)
        {
            try
            {
                TextBox textBox = sender as TextBox;
        ...
        public void AllowOnly2Decimals(object sender)
        {
            try
            {
                TextBox textBox = sender as TextBox;
        ...
        public void AllowOnly4Decimals(object sender)
        {
            try
            {
                TextBox textBox = sender as TextBox;
