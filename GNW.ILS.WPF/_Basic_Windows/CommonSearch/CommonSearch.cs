...
namespace Pervation.Presentation._Basic_Windows.CommonSearch
{
  public  class CommonSearch
  {
        ...
        private static frmCommonSearch AssignSearchDetails(string zSearchCode)
        {
            frmCommonSearch objSearchForm = new frmCommonSearch();
            try
            {
        ...
        private static frmCommonSearch AssignSearchDetails(string zSearchCode, string zServerName)
        {
            frmCommonSearch objSearchForm = new frmCommonSearch();
            try
            {
        ...
        private static frmCommonSearch AssignSearchDetails(string zSearchCode, bool isStatusFields, string StatusFields)
        {
            frmCommonSearch objSearchForm = new frmCommonSearch(isStatusFields, StatusFields);
            try
            {
                DataSet dsSearchType = new CommonSearchDataAccess().GetSearchType(zSearchCode);
                if (dsSearchType.Tables[0].Rows.Count > 0)
        ...
        private static frmCommonSearch AssignSearchDetails(string zSearchCode, string zServerName, bool isStatusFields, string StatusFields)
        {
            frmCommonSearch objSearchForm = new frmCommonSearch(isStatusFields, StatusFields);
            try
            {
                                               ...
                                               bool bAllowMultipleSelection, bool bHidePrimaryKeyField,bool isStatusFields,string StatusFields)
        {
            ...
            {
                //Read Database and get all the relevent details
                objSearchForm = AssignSearchDetails(zSearchCode, isStatusFields, StatusFields);
